...
cam1 = {"start_pair":("D", "C"), "u_pair":(2,3), "v_pair":(0,1), "position":3}
cam2 ={"start_pair":("A", "D"), "u_pair":(0,1), "v_pair":(2,3), "position":3}
cam3 = {"start_pair":("A", "D"),"u_pair":(0,1), "v_pair":(2,3), "position":2}
cam4 ={"start_pair":("B", "A"), "u_pair":(2,3), "v_pair":(0,1), "position":1}
cam5 = {"start_pair":("C", "B"), "u_pair":(0,1), "v_pair":(2,3), "position":1}
cam6 ={"start_pair":("D", "C"), "u_pair":(2,3), "v_pair":(0,1), "position":2}